...
F 0 "#U011" H 10200 2425 50  0001 C CNN
F 1 "+4.7V" H 10100 2400 50  0000 L CNN
...
F 0 "#U010" H 9850 3675 50  0001 C CNN
F 1 "+4.7V" H 9750 3650 50  0000 L CNN
...
F 1 "CUS08F30H3FCT-ND" H 7650 3800 50  0000 C CNN
F 2 "Diode_SMD:D_SOD-323_HandSoldering" H 7650 3600 50  0001 C CNN
...
F 0 "JP3" V 3454 3877 50  0000 L CNN
...
F 0 "TP4" H 10533 2743 50  0000 L CNN
F 1 "PEAK_OUT" H 10533 2652 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x01_P2.54mm_Vertical" H 10675 2625 50  0001 C CNN
F 3 "~" H 10675 2625 50  0001 C CNN
	1    10475 2625
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "#PWR036" H 9850 3550 50  0001 C CNN
...
F 0 "C23" H 9965 3696 50  0000 L CNN
F 1 "0.1u" H 9965 3605 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 9888 3500 50  0001 C CNN
...
F 0 "C20" H 4350 4300 50  0000 C CNN
F 1 "0.1n" H 4339 4400 50  0000 C CNN
...
F 0 "R16" V 3993 4200 50  0000 C CNN
...
Wire Wire Line
	10350 1800 10350 2625
Wire Wire Line
	8900 1800 10350 1800
Wire Wire Line
	8900 2700 8900 1800
Wire Wire Line
	9050 2700 8900 2700
...
F 0 "R19" H 8720 3846 50  0000 L CNN
F 1 "1M" H 8720 3755 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 8580 3800 50  0001 C CNN
...
F 1 "2.2n" H 8365 3755 50  0000 L CNN
...
F 0 "#PWR030" H 3900 4450 50  0001 C CNN
...
F 0 "R15" H 3970 4446 50  0000 L CNN
...
F 0 "C19" V 3448 4200 50  0000 C CNN
...
F 0 "U7" H 8300 1050 50  0000 C CNN
F 1 "LTC6269" H 8300 950 50  0000 C CNN
F 2 "Package_SO:MSOP-8_3x3mm_P0.65mm" H 7700 1000 50  0001 C CNN
...
F 0 "U6" H 4150 1200 50  0000 C CNN
F 1 "LTC6269" H 4150 1100 50  0000 C CNN
...
F 0 "#PWR034" H 8250 3850 50  0001 C CNN
...
F 0 "#PWR035" H 8650 3850 50  0001 C CNN
...
F 0 "TP3" H 4908 4318 50  0000 L CNN
...
F 0 "#U09" H 5800 2675 50  0001 C CNN
