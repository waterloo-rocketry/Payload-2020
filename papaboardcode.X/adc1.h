...
typedef enum 
{
    channel_BATT_CURR_AMP = 0b00000,//Channel Name:AN1   Assigned to:Shared Channel
    channel_3V3_CURR_AMP = 0b00001,//Channel Name:CTMU Temp   Assigned to:Shared Channel
    channel_V_SENSE = 0b00011,//Channel Name:CTMU   Assigned to:Shared Channel
} ADC1_CHANNEL;
