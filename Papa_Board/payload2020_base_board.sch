...
F8 "DET6_ADC" I R 8350 5550 50 
F9 "DET5_ADC" I R 8350 5200 50 
F10 "DET4_ADC" I R 8350 4850 50 
F11 "DET3_ADC" I R 8350 4550 50 
F12 "DET6_INTERRUPT" I R 8350 5650 50 
F13 "DET5_INTERRUPT" I R 8350 5300 50 
F14 "DET4_INTERRUPT" I R 8350 4950 50 
F15 "DET3_INTERRUPT" I R 8350 4650 50 
F16 "DET2_INTERRUPT" I R 8350 4350 50 
F17 "DET1_INTERRUPT" I R 8350 4000 50 
F18 "ISCPDAT" I L 3700 3700 50 
F19 "MCLR" I L 3700 3900 50 
F20 "DET1_ADC" I R 8350 3900 50 
F21 "DET2_ADC" I R 8350 4250 50 
...
U 1 1 609E30E9
P 5150 2225
F 0 "#PWR021" H 5150 2075 50  0001 C CNN
F 1 "+12V" H 5165 2398 50  0000 C CNN
...
U 1 1 60A6BCE0
P 9950 2100
F 0 "#PWR023" H 9950 1950 50  0001 C CNN
...
$EndComp
$Sheet
S 4000 1400 950  1150
U 5E13F8E9
F0 "battery_management" 50
F1 "battery_management.sch" 50
F2 "5V" I R 4950 1550 50 
F3 "Battery" I L 4000 1550 50 
F4 "POWER_EN" I R 4950 1975 50 
F5 "12V" I R 4950 2225 50 
$EndSheet
$Comp
L Connector_Generic:Conn_01x10 J5
U 1 1 60A93909
P 10550 2500
F 0 "J5" H 10500 3250 50  0000 L CNN
F 1 "1053141210" H 10500 3150 50  0000 L CNN
...
U 1 1 60ADF62A
P 9750 2100
F 0 "#PWR017" H 9750 1950 50  0001 C CNN
...
U 1 1 60AE618B
P 10650 4900
F 0 "J6" H 10575 5650 50  0000 L CNN
F 1 "1053141210" H 10575 5575 50  0000 L CNN
...
U 1 1 60B15F11
P 9850 4500
F 0 "#PWR019" H 9850 4350 50  0001 C CNN
...
F 3 "~" H 1200 3800 50  0001 C CNN
	...
	-1   0    0    1   
$EndComp
Text HLabel 975  6850 2    50   Input ~ 0
MOSI
Text HLabel 975  7050 2    50   Input ~ 0
MISO
Text HLabel 975  7250 2    50   Input ~ 0
CS
Text HLabel 975  7450 2    50   Input ~ 0
SCK
Text HLabel 5425 5950 1    50   Input ~ 0
MOSI
Text HLabel 5575 5950 1    50   Input ~ 0
MISO
Text HLabel 5750 5950 1    50   Input ~ 0
CS
Text HLabel 5900 5950 1    50   Input ~ 0
SCK
Text Label 5750 5950 3    50   ~ 0
CS
Text Label 5575 5950 3    50   ~ 0
MISO
Text Label 5425 5950 3    50   ~ 0
MOSI
Text Label 5900 5950 3    50   ~ 0
SCK
Text Label 975  7250 2    50   ~ 0
CS
Text Label 975  7050 2    50   ~ 0
MISO
Text Label 975  6850 2    50   ~ 0
MOSI
Text Label 975  7450 2    50   ~ 0
SCK
...
F1 "SDcard.sch" 50
$EndSheet
Text HLabel 975  6675 2    50   Input ~ 0
3.3V
$Comp
L power:+3.3V #PWR?
U 1 1 60B0C91D
P 750 6675
F 0 "#PWR?" H 750 6525 50  0001 C CNN
F 1 "+3.3V" H 765 6848 50  0000 C CNN
F 2 "" H 750 6675 50  0001 C CNN
...
Wire Wire Line
	750  6675 975  6675
Text HLabel 4950 1775 0    50   Input ~ 0
3.3V
Wire Wire Line
	4950 1775 5150 1775
$Comp
...
F 1 "+3.3V" H 5165 1948 50  0000 C CNN
...
U 1 1 60BDB794
P 3625 1525
AR Path="/5E13F8E9/60BDB794" Ref="#PWR?"  Part="1" 
AR Path="/60BDB794" Ref="#PWR?"  Part="1" 
F 0 "#PWR?" H 3625 1375 50  0001 C CNN
F 1 "+BATT" H 3640 1698 50  0000 C CNN
